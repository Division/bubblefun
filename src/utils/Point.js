...
Point.prototype = {
     ...
     * @param {number} value - The value to multiply Point.xy by.
     * @return {Phaser.Point} This Point object. Useful for chaining method calls.
     */
    ...
    angle: function (a, asDegrees) {
        ...
        if (asDegrees)
        {
            return (Math.atan2(a.y - this.y, a.x - this.x)) * 180 / Math.PI;
        }
        else
        {
 ...
 * @return {Phaser.Point} The new Point object.
 */
Point.multiply = function (a, value, out) {
...
Point.multiplyFloat = function (a, value, out) {
